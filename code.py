...
def change(folder_path, image_name):
    ...
    if(os_name == "posix"):
        ...
        if(os.path.exists("C:\Users\rafsa\Desktop\main\images")):
            os.system("C:\Users\rafsa\Desktop\main\images set org.gnome.desktop.background picture-uri '" + image_path + "'")
    elif(os_name == "nt"):
